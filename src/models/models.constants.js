...
export const CATEGORY_HAS_MANY_SUB_CATEGORY_FK = 'category_id';
export const CATEGORY_HAS_MANY_SUB_CATEGORY_ALIAS = 'subCategories';
export const CATEGORY_HAS_MANY_SUB_PRODUCT_FK = 'category_id';
...
export const LOCATION_HAS_MANY_SALES_FK = 'location_id';
export const LOCATION_HAS_MANY_SALES_ALIAS = 'sales';

// PRODUCT
export const PRODUCT_MODEL_NAME = 'Product';
export const PRODUCT_TABLE_NAME = 'products';
export const PRODUCT_HAS_MANY_SALES_FK = 'product_id';
...
export const PRODUCT_HAS_MANY_INVENTORY_MOVEMENT_FK = 'product_id';
...
export const SALES_HAS_MANY_INVENTORY_MOVEMENT_FK = 'sales_id';
...
export const SEGMENT_HAS_MANY_SALES_FK = 'segment_id';
export const SEGMENT_HAS_MANY_SALES_ALIAS = 'sales';
...
export const SUB_CATEGORY_HAS_MANY_PRODUCT_FK = 'sub_category_id';
export const SUB_CATEGORY_HAS_MANY_PRODUCT_ALIAS = 'products';